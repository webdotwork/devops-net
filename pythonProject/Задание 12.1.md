...
- проверить работу приложения из задания 2, запустив port-forward до кластера
  ```
  www@mkb:~$ kubectl get pod,deploy,svc
  NAME                             READY   STATUS    RESTARTS   AGE
  pod/hello-node-697897c86-c497x   1/1     Running   0          64m

  NAME                         READY   UP-TO-DATE   AVAILABLE   AGE
  deployment.apps/hello-node   1/1     1            1           64m

  NAME                 TYPE           CLUSTER-IP     EXTERNAL-IP   PORT(S)          AGE
  service/hello-node   LoadBalancer   10.98.117.12   <pending>     8080:31136/TCP   61m
